                    ...
                    <?php
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                $estadoClass = $row['estado'] ? 'danger' : 'success';
                                ...
                                echo '<td class="text-center text-white"><span class="badge bg-' . $estadoClass . '">' . $estado . '</span></td>';
                                echo '<td class="text-center">
                                        <a href="?id=' . $row['id'] . '&estado=' . ($row['estado'] ? 'false' : 'true') . '" class="btn btn-info btn-sm"><i class="fas fa-' . $estadoIcon . '"></i> ' . $estadoText . '</a>
                                    </td>';
                                echo '</tr>';
                            }
                        } else {
