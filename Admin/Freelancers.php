...
if (isset($_GET['id']) && isset($_GET['status'])) {
    ...
    $sql = "UPDATE freelancers SET Estado = $status WHERE id = $id";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">Freelancers</a>
...
<div class="container mt-5 content-wrapper">
    <div class="card">
        <div class="card-header bg-primary text-white">
            <h2 class="card-title m-0" style="color: white;">Lista de Freelancers</h2>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="freelancersTable" class="table table-bordered table-striped table-hover">
                    <thead>
                        <tr class="text-center">
                            ...
                            <th><i class="fas fa-file-alt"></i> Habilidades</th>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>
                                    ...
                                    <td>{$row['telefono']}</td>
                                    <td>{$row['direccion']}</td>
                                    <td>{$row['descripcion_habilidades']}</td>
                            ...
                            echo "<tr><td colspan='10' class='text-center'>No se encontraron freelancers</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
        ...
        <div class="card-footer text-muted text-center">
            <p class="mb-0">© 2024 Freelancers</p>
        </div>
    </div>
</div>
...
function toggleStatus(id, status) {
    Swal.fire({
        title: status ? '¿Activar freelancer?' : '¿Desactivar freelancer?',
        icon: 'question',
