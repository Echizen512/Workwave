...
.form-container {
    background: #fff;
    padding: 20px; /* Reducido el padding para pantallas pequeñas */
    border-radius: 12px;
...
h2 {
    margin-top: 0;
    color: #333;
    font-size: 24px; /* Reducido el tamaño de fuente para pantallas pequeñas */
    text-align: center;
}
...
label {
    ...
    font-weight: bold;
    color: #444;
    font-size: 14px; /* Reducido el tamaño de fuente para pantallas pequeñas */
}

label i {
    margin-right: 8px; /* Reducido el margen derecho */
    color: #007BFF;
    font-size: 16px; /* Reducido el tamaño de icono para pantallas pequeñas */
}
...
textarea {
    width: 100%;
    padding: 12px; /* Reducido el padding para pantallas pequeñas */
...
textarea {
    resize: vertical;
    min-height: 120px; /* Reducido la altura mínima para pantallas pequeñas */
}
...
button {
    ...
    border-radius: 8px;
    cursor: pointer;
    font-size: 16px; /* Reducido el tamaño de fuente para pantallas pequeñas */
    ...
    <div class="form-container">
        ...
        <form action="register_freelancer.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="freelancer_portafolio" name="freelancer_portafolio" placeholder="https://www.example.com">
            </div>
